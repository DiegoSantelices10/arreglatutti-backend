...
export interface ApiProfesionProfesion extends Struct.CollectionTypeSchema {
  collectionName: 'profesiones';
  info: {
    description: '';
    displayName: 'Profesion';
    pluralName: 'profesiones';
...
export interface ApiProfesionalProfesional extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imgProfile: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    imgWorks: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
